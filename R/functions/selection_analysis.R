...
#' Complete selection analysis wrapper
#'
#' Performs data preparation, linear selection analysis, nonlinear selection analysis,
#' and extracts results all in one step.
#'
...
#' @param family Optional GLM family object to override automatic detection.
#'
#' @return A list containing the coefficients table, prepared data, models, and metadata.
#' @export
#'
#' @examples
#' \dontrun{
#' results <- selection_analysis(my_data, "fitness", c("trait1", "trait2"))
#' }
